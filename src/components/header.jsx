    ...
    <header className="custom-bg flex justify-between items-center w-full p-4 relative">
      ...
      {isHamburgerOpen && (
        <ul className="mobile-screen flex flex-col items-end absolute top-full right-0 w-full bg-[#0a192f] py-4 px-6 sm:hidden">
          ...
          <li className="w-full flex justify-end mt-2">
            <a
              className="rounded-2xl text-white px-4 py-2 border-2 border-transparent hover:border-amber-500 shadow-none hover:shadow-lg hover:shadow-amber-500 transition-all duration-300"
              href="/resume"
            >
              Resume
            </a>
